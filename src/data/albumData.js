    ...
    album: [
        {
            ...
            events: [
                ...
                { id: 8, type: "image", title: "졸업생 환송회", date: "2025.12", image: process.env.PUBLIC_URL + "/assets/album_IMGS/2021경기대 전기 학위수여식.jpg", participants: "전체 연구실 구성원" },
                { id: 7, type: "video", title: "연구실 홈피 개발기록", date: "2025.03", videoUrl: process.env.PUBLIC_URL + "/assets/album_IMGS/연구실 홈피 프로토타입1080.mp4", Thumbnail: "", participants: "박태경" },
            ]
        },
        {
            year: "2024",
